# Dashboard de Análisde de Padrões de Consumo de Clientes
...
* **Distribuição de Clientes por Idade (Customers by Age):** Gráfico responsável por segmentar os consumidores por faixa etária, permitindo identificar os principais públicos da base de dados.
* **Cores Mais Compradas por Estação (Most Purchased Color by Season):** Visualização que relaciona as cores mais consumidas com cada estação do ano, auxiliando no planejamento de estoque, campanhas sazonais e tendências de mercado.
* **Categorias Mais Compradas (Most Purchased Category):** Gráfico que destaca as categorias de produtos com maior volume de compras e relevância comercial.

## Recursos utilizados
* **Power BI:** Desenvolvimento do dashboard e construção visual do relatório
* **Power Query:** Processo ETL (Extração, Transformação e Limpeza dos Dados)

## Como executar o projeto
1. Instale o **Power BI Desktop**.
2. Faça o download ou clone este repositório.
3. Abra o arquivo `.pbix` no **Power BI Desktop**.
4. Explore os filtros e interações disponíveis no dashboard.
